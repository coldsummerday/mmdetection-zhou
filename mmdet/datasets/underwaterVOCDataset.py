...
class UnderwaterVOCDataset(CustomDataset):
    ...
    def __init__(self, min_size=None, **kwargs):
        super(UnderwaterVOCDataset, self).__init__(**kwargs)
    ...
    def load_annotations(self, ann_file):
        ...
        for img_id in img_ids:
            filename =osp.join(self.data_root,'train','image', '{}.jpg').format(img_id)
            img_info = hw_json[img_id]
            img_infos.append(
                dict(id=img_id, filename=filename, width=img_info['width'], height=img_info['height']))
        return img_infos
